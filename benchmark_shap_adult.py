...
from train_adult import load_data, validate, save_checkpoint
...
if __name__ == "__main__":
    ...
    model_checkpoint_fname = "/opt/data/private/wzf/u_shapley/shapley_accelerated/adult-dataset/model_adult_m_1_r_0.pth.tar"
